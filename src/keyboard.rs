...
impl FromPrimitive for Key {
    fn from_u64(n: u64) -> Option<Key> {
        match n {
            ...
            1073741908 => Some(KpDivide),
            1073741909 => Some(KpMultiply),
            1073741910 => Some(KpMinus),
            1073741911 => Some(KpPlus),
            1073741912 => Some(KpEnter),
            1073741913 => Some(Kp1),
            1073741914 => Some(Kp2),
            1073741915 => Some(Kp3),
            1073741916 => Some(Kp4),
            ...
            1073741921 => Some(Kp9),
            1073741922 => Some(Kp0),
            1073741923 => Some(KpPeriod),
            1073741925 => Some(Application),
            1073741926 => Some(Power),
            1073741927 => Some(KpEquals),
            1073741928 => Some(F13),
            1073741929 => Some(F14),
            1073741930 => Some(F15),
            1073741931 => Some(F16),
            ...
            1073741957 => Some(KpComma),
            1073741958 => Some(KpEqualsAS400),
            ...
            1073742000 => Some(Kp00),
            1073742001 => Some(Kp000),
            ...
            1073742006 => Some(KpLeftParen),
            1073742007 => Some(KpRightParen),
            1073742008 => Some(KpLeftBrace),
            1073742009 => Some(KpRightBrace),
            1073742010 => Some(KpTab),
            1073742011 => Some(KpBackspace),
            1073742012 => Some(KpA),
            1073742013 => Some(KpB),
            1073742014 => Some(KpC),
            1073742015 => Some(KpD),
            1073742016 => Some(KpE),
            1073742017 => Some(KpF),
            1073742018 => Some(KpXor),
            1073742019 => Some(KpPower),
            1073742020 => Some(KpPercent),
            1073742021 => Some(KpLess),
            1073742022 => Some(KpGreater),
            1073742023 => Some(KpAmpersand),
            1073742024 => Some(KpDblAmpersand),
            1073742025 => Some(KpVerticalBar),
            1073742026 => Some(KpDblVerticalBar),
            1073742027 => Some(KpColon),
            1073742028 => Some(KpHash),
            1073742029 => Some(KpSpace),
            1073742030 => Some(KpAt),
            1073742031 => Some(KpExclam),
            1073742032 => Some(KpMemStore),
            1073742033 => Some(KpMemRecall),
            1073742034 => Some(KpMemClear),
            1073742035 => Some(KpMemAdd),
            1073742036 => Some(KpMemSubtract),
            1073742037 => Some(KpMemMultiply),
            1073742038 => Some(KpMemDivide),
            1073742039 => Some(KpPlusMinus),
            1073742040 => Some(KpCear),
            1073742041 => Some(KpClearEntry),
            1073742042 => Some(KpBinary),
            1073742043 => Some(KpOctal),
            1073742044 => Some(KpDecimal),
            1073742045 => Some(KpHexadecimal),
